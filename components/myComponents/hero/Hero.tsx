  ...
  return (
    <div id="hero" className="flex flex-col py-10 px-7">
      ...
      <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
        ...
        <a id="cv-button" href="https://drive.google.com/file/d/1ID5yXvDpwMKJeZ0RUROH7jQlyV5Zm_L8/view?usp=drive_open" target="_blank" className="flex gap-1 w-28 justify-between text-xs text-center bg-transparent main-col border border-[#24453b] rounded-2xl px-3 py-2 items-center transition-all duration-300 hover:bg-[#24453b] hover:text-[white]">
          My Resume<AiFillFileText className="text-sm" />
        </a>
        </div>
